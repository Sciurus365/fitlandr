...
calculate_probability_flow <- function(rho, drift_func, diffusion_func,
	...
	out_x <- numeric(n_total); out_y <- numeric(n_total)
	out_Jx <- numeric(n_total); out_Jy <- numeric(n_total)
	out_Jx_rho <- numeric(n_total); out_Jy_rho <- numeric(n_total)
