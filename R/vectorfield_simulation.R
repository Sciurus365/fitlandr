...
#'
#' For `method = "simlandr"`, the landscape is constructed based on the generalized potential landscape by Wang et al (2008), implemented by the `simlandr` package.
#'
#' @param vf A `vectorfield` object estimated by [fit_vf_2d()].]
...
#' @export
simlandr_options <- function(vf, x = vf$x, y = vf$y, n = 200, lims = c(vf$x_start, vf$x_end, vf$y_start, vf$y_end), Umax = 8, h = 0.1, kde_fun = "ks") {
